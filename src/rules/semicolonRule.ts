...
class SemicolonWalker extends Lint.RuleWalker {
    ...
    private checkSemicolonAt(node: ts.Node, override?: "never") {
        ...
        const always = override !== "never" && (this.hasOption(OPTION_ALWAYS) || (this.getOptions() && this.getOptions().length === 0));
        ...
        } else if ((this.hasOption(OPTION_NEVER) || override === "never") && hasSemicolon) {
